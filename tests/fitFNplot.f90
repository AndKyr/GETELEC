...
real(dp)                :: var, epsfit = 1.d-20, params(5), pmin(5), pmax(5), yshift
type(pyplot)            :: plt
...
pmin =   [0.5d0 * sum(xdata)/Ndata, 4.1d0, 0.1d0, 5.d0, 290.d0]
params = [5.d0 * sum(xdata)/Ndata, 4.5d0, 3.d0, 10.d0, 300.d0]
pmax =   [15.d0 * sum(xdata)/Ndata, 4.6d0, 1.d2, 15.d0, 310.d0]
...
call plt%initialize(grid=.true.,xlabel='$1/F [nm/V])$',ylabel='$log(I) [A]$', &
