...
!(function (t, e) {
    ...
    function Oe(t, e = [""], i = t, s, n = () => t[0]) {
        ...
        const o = { [Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: i, _fallback: s, _getTarget: n, override: (n) => Oe([n, ...t], e, i, s) };
        return new Proxy(o, {
        ...
        !(function (t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                (l = h),
                    ...
                    l &&
                        h &&
                        (Ht(e[c], 0, je) ? (i[c] = i[c + 1] = 0) : ((n = i[c] / e[c]), (o = i[c + 1] / e[c]), (r = Math.pow(n, 2) + Math.pow(o, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[c] = n * a * e[c]), (i[c + 1] = o * a * e[c]))));
        })(t, n, o),
            (function (t, e, i = "x") {
                const s = Ye(i),
                    n = t.length;
            ...
            (function (t, e) {
                ...
                for (i = 0, s = t.length; i < s; ++i)
                    (a = o),
                        (o = r),
                        (r = i < s - 1 && ve(t[i + 1], e)),
                        o && ((n = t[i]), a && ((n.cp1x = qe(n.cp1x, e.left, e.right)), (n.cp1y = qe(n.cp1y, e.top, e.bottom))), r && ((n.cp2x = qe(n.cp2x, e.left, e.right)), (n.cp2y = qe(n.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    const Ge = (t) => 0 === t || 1 === t,
        ...
        Qe = {
            ...
            easeInOutExpo: (t) => (Ge(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
            ...
            easeInOutElastic(t) {
                const e = 0.1125;
                return Ge(t) ? t : t < 0.5 ? 0.5 * Ze(2 * t, e, 0.45) : 0.5 + 0.5 * Je(2 * t - 1, e, 0.45);
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e);
            ...
            easeInOutBounce: (t) => (t < 0.5 ? 0.5 * Qe.easeInBounce(2 * t) : 0.5 * Qe.easeOutBounce(2 * t - 1) + 0.5),
        };
    function ti(t, e, i, s) {
    ...
    function vi(t, e, i) {
        ...
        for (let t = c, i = c; t <= d; ++t)
            (m = e[t % a]),
                m.skip || ((p = h(m[s])), p !== b && ((x = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(yi({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (b = p)));
    ...
    class Ns extends Os {
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(),
                ...
                this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = gi(this, n, s)), (this._dataLimitsCached = !0)),
            ...
            this._convertTicksToLabels(r ? Is(this.ticks, a) : this.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((this.ticks = Ls(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    class fn {
        constructor(t, e) {
            ...
            (this.id = Y()),
                ...
                (this._dataChanges = []),
                (cn[this.id] = this),
                l && h ? (a.listen(this, "complete", rn), a.listen(this, "progress", ln), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
            const {
        ...
        _drawDataset(t) {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) &&
                (s && we(e, { left: !1 === i.left ? 0 : n.left - i.left, right: !1 === i.right ? this.width : n.right + i.right, top: !1 === i.top ? 0 : n.top - i.top, bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom }),
                t.controller.draw(),
                s && Me(e),
                (o.cancelable = !1),
    ...
    (Dn.id = "bar"),
        (Dn.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }),
        (Dn.overrides = { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
    class Cn extends Cs {
        initialize() {
            (this.enableOptionSharing = !0), super.initialize();
        }
    ...
    (Cn.id = "bubble"),
        (Cn.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }),
        (Cn.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } });
    class On extends Cs {
        constructor(t, e) {
    ...
    (On.id = "doughnut"),
        ...
        (On.descriptors = { _scriptable: (t) => "spacing" !== t, _indexable: (t) => "spacing" !== t }),
        (On.overrides = {
            aspectRatio: 1,
            plugins: {
                legend: {
    ...
    (Rn.id = "radar"),
        (Rn.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
        (Rn.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
    class En extends An {}
    (En.id = "scatter"),
        (En.defaults = { showLine: !1, fill: !1 }),
        (En.overrides = { interaction: { mode: "point" }, plugins: { tooltip: { callbacks: { title: () => "", label: (t) => "(" + t.label + ", " + t.formattedValue + ")" } } }, scales: { x: { type: "linear" }, y: { type: "linear" } } });
    ...
    (Wn.id = "arc"),
        (Wn.defaults = { borderAlign: "center", borderColor: "#fff", borderJoinStyle: void 0, borderRadius: 0, borderWidth: 2, offset: 0, spacing: 0, angle: void 0 }),
    ...
    (Gn.id = "line"),
        (Gn.defaults = { borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", borderWidth: 3, capBezierPoints: !0, cubicInterpolationMode: "default", fill: !1, spanGaps: !1, stepped: !1, tension: 0 }),
    ...
    class Jn extends Os {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < 0.1 || !ve(this, e, this.size(i) / 2) || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), ye(t, i, this.x, this.y));
        }
        getRange() {
            const t = this.options || {};
    ...
    (Jn.id = "point"),
        (Jn.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }),
    ...
    function go(t, e) {
        ...
        return (
            ...
            i.length ? new Gn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
        );
    }
    function po(t, e, i) {
        let s = t[e].fill;
                ...
                for (const t of s) {
                    ...
                    for (const e of h) {
                        const s = co(i, o[e.start], o[e.end], e.loop),
                            r = vi(t, n, s);
                        for (const t of r) a.push({ source: t, target: e, start: { [i]: fo(l, s, "start", Math.max) }, end: { [i]: fo(l, s, "end", Math.min) } });
                    }
                }
                return a;
            })(i, s, n);
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (o = t.getDatasetMeta(a)),
                    (r = o.dataset),
                    (l = null),
                    r && r.options && r instanceof Gn && (l = { visible: t.isDatasetVisible(a), index: a, fill: mo(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
                    (o.$filler = l),
                    n.push(l);
    ...
    class Yo extends Os {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ho(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = ui(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r)
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ho(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = ui(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a)
        ...
        draw(t) {
            ...
            e.enabled &&
                a &&
                (t.save(), (t.globalAlpha = i), this.drawBackground(n, t, s, e), bi(t, e.textDirection), (n.y += o.top), this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), xi(t, e.textDirection), t.restore());
        }
        getActiveElements() {
            return this._active || [];
        }
            ...
            const s = (function (t, e) {
                ...
                (M = Math.ceil(p / k) - Math.floor(g / k)),
                    ...
                    m && b && n && jt((a - o) / n, k / 1e3)
                        ...
                        : ((M = (w - v) / k), (M = Ht(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M)));
        ...
        buildTicks() {
            const t = this.options,
                e = (function (t, e) {
                    ...
                    do {
                        n.push({ value: o, major: Qo(o) }), ++r, 10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)), (o = Math.round(r * Math.pow(10, a) * l) / l);
                    } while (a < i || (a === i && r < s));
                    const h = G(t.max, o);
                        ...
                        if (0 !== e) {
                            ...
                            !(function (t, e, i, s) {
                                ...
                                (!o && !s) ||
                                    ...
                                    !r ||
                                    i < 0 ||
                                    (n.save(), (n.strokeStyle = a), (n.lineWidth = r), n.setLineDash(e.borderDash), (n.lineDashOffset = e.borderDashOffset), n.beginPath(), la(t, i, o, s), n.closePath(), n.stroke(), n.restore());
    ...
    (ha.id = "radialLinear"),
        ...
        (ha.defaultRoutes = { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
